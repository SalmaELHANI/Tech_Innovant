      ...
      <div className="container mx-auto">
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px]">
                Services Technologiques de Pointe
              </h2>
        ...
        <div className="-mx-4 flex flex-wrap">
          <ServiceCard
            ...
            details="Libérez le potentiel de l'intelligence artificielle avec nos solutions avancées qui améliorent la prise de décision et automatisent les processus et automatisent les processus ."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="Adoptez la flexibilité des solutions cloud. Nous proposons des services informatiques en nuage évolutifs et sécurisés adaptés à vos besoins commerciaux."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="Connectez et optimisez vos appareils avec l'Internet des objets. Nos services d'intégration IoT apportent efficacité et informations en temps réel à votre entreprise."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="Protégez votre entreprise contre les menaces cybernétiques. Nos services de cybersécurité garantissent l'intégrité et la confidentialité de vos actifs numériques."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="Explorez la sécurité et la transparence de la technologie blockchain. Nous proposons des services de développement sur mesure pour vos applications décentralisées."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="Explorez de nouvelles dimensions avec nos solutions de réalité virtuelle et augmentée. Nous concevons des expériences immersives pour améliorer l'engagement client ."
            icon={
              <svg
                width="36"
                height="36"
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3 ">
        <div className="mb-9 rounded-[20px] bg-white p-10 shadow-2xl hover:shadow-blue-500/50 dark:bg-dark-2 md:px-7 xl:px-10">
          <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-blue-700">
            {icon}
          </div>
